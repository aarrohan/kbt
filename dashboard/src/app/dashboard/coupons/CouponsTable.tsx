...
const columns: ColumnDef<TableRow>[] = [
  ...
  },
  {
    ...
    cell: ({ table, row }) => {
      ...
      const { mutate: deleteCoupon } = trpc.coupon.delete.useMutation({
        onSuccess: () => {
          tableMeta.refetchCoupons();
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/dashboard/coupons/${tableRow.id}`}>Edit</Link>
            </DropdownMenuItem>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="font-medium">
                    This will permanently delete and remove the coupon from
                    database
                  </AlertDialogDescription>
                </AlertDialogHeader>
